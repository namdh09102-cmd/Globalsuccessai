    ...
    <div className="min-h-full p-6 space-y-6 select-none bg-slate-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        {/* ========================================================
            ...
            ======================================================== */}
        <div className="xl:col-span-1 rounded-3xl bg-white border border-slate-200 p-6 flex flex-col space-y-6 relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
          ...
          <div className="grid grid-cols-2 gap-4 flex-1">
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4 space-y-2 group hover:border-indigo-500/40 transition-colors">
              <div className="flex items-center gap-2 text-indigo-400">
                <Users className="w-4 h-4" />
                <span className="text-[10px] font-bold uppercase">Tổng học viên</span>
              </div>
              <div>
                <span className="text-xl font-black text-slate-800 group-hover:text-indigo-300 transition-colors">12,450</span>
            ...
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4 space-y-2 group hover:border-rose-500/40 transition-colors">
              <div className="flex items-center gap-2 text-rose-400">
                <BookOpen className="w-4 h-4" />
                <span className="text-[10px] font-bold uppercase">TK Giáo viên</span>
              </div>
              <div>
                <span className="text-xl font-black text-slate-800 group-hover:text-rose-300 transition-colors">320</span>
                <p className="text-[9px] text-slate-500 font-bold mt-1">Trường & Trung tâm</p>
              </div>
            </div>

            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4 space-y-2 group hover:border-emerald-500/40 transition-colors">
              <div className="flex items-center gap-2 text-emerald-400">
                <Wallet className="w-4 h-4" />
                <span className="text-[10px] font-bold uppercase">Doanh thu PRO</span>
              </div>
              <div>
                <span className="text-xl font-black text-slate-800 group-hover:text-emerald-300 transition-colors">45.8M</span>
                <p className="text-[9px] text-slate-500 font-bold mt-1">Đồng bộ VietQR</p>
              </div>
            </div>

            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4 space-y-2 group hover:border-violet-500/40 transition-colors">
              <div className="flex items-center gap-2 text-violet-400">
                <Activity className="w-4 h-4" />
                <span className="text-[10px] font-bold uppercase">Tỷ lệ chuyển đổi</span>
              </div>
              <div>
                <span className="text-xl font-black text-slate-800 group-hover:text-violet-300 transition-colors">4.2%</span>
                <p className="text-[9px] text-emerald-400 font-bold mt-1 flex items-center gap-0.5">
        ...
        <div className="xl:col-span-1 rounded-3xl bg-white border border-slate-200 p-6 flex flex-col space-y-6 relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <button 
              ...
              className="mt-auto w-full py-2.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-slate-800 text-xs font-bold transition-all"
            >
              Lưu cấu hình AI
            </button>
          </div>
