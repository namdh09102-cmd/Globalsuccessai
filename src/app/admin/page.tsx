          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-[#0B0F19] border border-slate-800 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-rose-500/50 transition-colors placeholder-slate-700 font-mono"
              />
            </div>
            <button 
              onClick={handleSaveApi}
              className="mt-auto w-full py-2.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-white text-xs font-bold transition-all"
            >
              Lưu cấu hình AI
            </button>
          </div>
