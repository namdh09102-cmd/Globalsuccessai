...
export default function AIPracticePage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto space-y-8 select-none animate-fadeIn">
      ...
      <div className="rounded-3xl border border-slate-800/80 bg-[#151B2B] p-6 shadow-xl space-y-4 hover:border-slate-700/50 transition-all duration-300 relative overflow-hidden group">
        ...
        <textarea
          ...
          className="w-full rounded-2xl border border-slate-850 bg-[#0B0F19] p-4 text-slate-200 text-base md:text-sm focus:border-violet-500 focus:ring-2 focus:ring-violet-550/20 outline-none transition-all resize-none custom-scrollbar shadow-inner"
        />
      ...
      <div className="rounded-3xl border border-slate-800/80 bg-[#151B2B] p-6 shadow-xl space-y-6 hover:border-slate-700/50 transition-all duration-300 relative overflow-hidden flex flex-col items-center justify-center text-center">
        ...
        {audioUrl && !isRecording && (
          <div className="w-full max-w-md pt-4 flex flex-col items-center gap-4 animate-fadeIn">
            ...
            <div className="w-full p-3 rounded-2xl bg-slate-900/40 border border-slate-800/40 flex items-center justify-between gap-3 shadow-inner">
            ...
            <div className="flex gap-3 w-full">
              <button
                ...
                className="flex-1 py-3 rounded-2xl border border-slate-800 bg-slate-800/15 hover:bg-slate-850 hover:text-slate-200 text-slate-400 text-xs font-bold transition-all active:scale-[0.98] flex items-center justify-center gap-2"
              >
      ...
      {evaluationResult && !isRecording && (
        <div className="rounded-3xl border border-slate-850 bg-[#151B2B] p-6 shadow-xl space-y-6 animate-fadeIn relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 border-b border-slate-800/40 pb-4">
            ...
            <div>
              <h2 className="text-sm font-bold text-slate-100">Báo cáo đánh giá phát âm AI</h2>
              <p className="text-[10px] text-slate-400">Phân tích âm học chi tiết bằng Whisper & AI Coach</p>
            </div>
          </div>
          ...
          {rewardClaimed && (
            <div className="rounded-2xl border border-emerald-500/15 bg-gradient-to-r from-emerald-500/10 to-teal-500/5 p-4 flex items-center justify-between shadow-md shadow-emerald-950/10 animate-bounce">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xs font-bold text-slate-100">Luyện tập xuất sắc!</h3>
                  <p className="text-[9px] text-slate-400">Bạn đã hoàn thành phát âm tự do với kết quả ấn tượng.</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-4 flex flex-col items-center justify-center p-6 rounded-2xl border border-slate-800/80 bg-[#0B0F19] text-center space-y-3">
              <div className="relative w-28 h-28 flex items-center justify-center">
                ...
                <div className="flex flex-col items-center">
                  <span className="text-3xl font-black text-slate-100">{evaluationResult.score}</span>
            ...
            <div className="md:col-span-8 flex flex-col justify-center space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="font-semibold text-slate-400">Ngữ điệu (Fluency)</span>
                  <span className="font-bold text-violet-400">{evaluationResult.fluency}%</span>
                </div>
                <div className="w-full h-2.5 rounded-full bg-slate-800 overflow-hidden border border-slate-900/40">
                  <div
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="font-semibold text-slate-400">Độ chuẩn (Pronunciation)</span>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="font-semibold text-slate-400">Trọng âm (Stress)</span>
          ...
          <div className="p-4 rounded-2xl border border-slate-800 bg-[#0B0F19] space-y-3 shadow-inner">
            ...
            <div className="flex flex-wrap gap-x-2 gap-y-2 text-sm leading-relaxed p-1 select-all">
              {evaluationResult.words.map((w, idx) => {
                let colorClass = "text-slate-350 bg-slate-800/10 border-slate-800/40";
            ...
            {/* Explanatory Legend */}
            <div className="flex items-center gap-4 pt-3 border-t border-slate-850/40 text-[9px] text-slate-500 font-bold uppercase tracking-wider">
          ...
          <div className="p-4 rounded-2xl border border-violet-500/15 bg-gradient-to-br from-[#121626] to-[#151930] flex gap-4 items-start shadow-inner">
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-violet-600 to-indigo-600 flex items-center justify-center font-bold text-white text-xs shrink-0 shadow-md">
              AI
            </div>
            <div className="space-y-1">
