...
export default function WorksheetRoom({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col items-center pb-20 h-screen overflow-hidden">
      {/* Sticky Header */}
      <div className="w-full bg-[#0B0F19]/90 backdrop-blur-xl border-b border-slate-800 p-4 flex items-center justify-between shadow-xl shrink-0">
        <button
          onClick={onBack}
      ...
      <div className="w-full flex-1 overflow-y-auto px-4 py-8 custom-scrollbar bg-[#0B0F19]">
        
        {mainAudio && (
          <div className="w-full max-w-4xl mx-auto mb-8 p-4 bg-[#151B2B] rounded-2xl border border-slate-800 flex flex-col gap-3 shadow-lg">
